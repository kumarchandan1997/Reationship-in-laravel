                ...
                <div class="row">
                  ...
                  <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"  name="short_des" value="{{$product->short_des}}" >
                    </div>
                  </div>
                  <div class="col-6">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        ...
                        <img src="{{ asset('product/image/'.$product->image) }}" width="70px" height="70px" alt="Image">
                      </div>
                  ...
                  <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"  name="meta_des" value="{{$product->meta_des}}" >
                    </div>
                  </div>
                  <div class="col-6">
                    <div class="form-group">
                  ...
                  <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"  name="og_title" value="{{$product->og_title}}" >
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        ...
                        <label class="custom-file-label" for="exampleInputFile">Choose file</label>
                        <img src="{{ asset('product/og_image/'.$product->og_image) }}" width="70px" height="70px" alt="Image">
                      </div>
                      <div class="input-group-append">
                        <span class="input-group-text">Upload</span>
                      </div>
